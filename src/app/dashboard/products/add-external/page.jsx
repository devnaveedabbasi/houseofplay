...
const INITIAL_FORM = {
  // Step 1
  productName: "Premium External Item",
  standard: true,

  thumbnail: null, // File object from input

  description:
    "Modern premium-quality external item designed for luxury interiors. Crafted with durable materials and smooth matte finishing for long-lasting performance and elegant appearance.",
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center p-6 pt-20 bg-slate-50">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div>
            <h2 className="text-2xl text-primary-600">External Item Added!</h2>
            <p className="text-primary-400 text-sm mt-2">
              The external item has been submitted successfully.
            </p>
        ...
        <div className="flex items-center justify-between pt-4">
          <div>
            ...
            <p className="text-sm mt-0.5 text-primary-400">
              Fill in the details below to add a new external item
            </p>
          </div>
